            ...
            {showQR && (
                <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.7)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16, zIndex: 1000 }}>
                    <div style={{ width: '100%', maxWidth: 360, background: 'white', border: '1px solid var(--color-border)', borderRadius: 16 }}>
                        ...
                        <div style={{ padding: 24, textAlign: 'center' }}><img src={showQR.qrCodeUrl} alt="QR Code" style={{ maxWidth: 200, margin: '0 auto', borderRadius: 8, background: 'white', padding: 16 }} /><p style={{ fontSize: 12, color: 'black', marginTop: 12, wordBreak: 'break-all' }}>{showQR.qrCodeData.replace(/^http:\/\/[^/]+/, 'https://serve-x-cd.vercel.app')}</p></div>
